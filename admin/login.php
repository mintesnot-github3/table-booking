  ...
  require('../db_connect.php');
    $msg_error = '';
        if(!empty($_POST['email']) && !empty($_POST['password'])){
            ...
            $check_phone = "select * from admin where email='$email'";
            ...
            if(@mysqli_fetch_row($run_check_phone) > 0){
                ...
                if($exact_pwd == $pwd){
                    ...
                    $msg_error = "<div style='color:red'>Phone number and password doesn't match</div>";
                }
            }else{
                    $msg_error = "<div style='color:red'>Phone number and password doesn't match</div>";
            }
...
<div class="col-md-6">
 <form action="" method="post">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="email" name="email" aria-describedby="email" required placeholder="Email">
  </div>
  <div class="mb-3">
